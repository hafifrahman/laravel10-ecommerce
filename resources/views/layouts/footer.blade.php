        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
          <div class="footer-links">
            ...
            <div class="footer-content">
              <ul>
                <li>
                  <a href="/" class="font-dark">Beranda</a>
                </li>
                <li>
                  <a href="/shop" class="font-dark">Belanja</a>
                </li>
                <li>
                  <a href="/about" class="font-dark">Tentang</a>
                </li>
                <li>
                  <a href="/contact" class="font-dark">Hubungi Kami</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <div class="sub-footer">
    <div class="container">
      <div class="row gy-3 justify-content-end">
        <div class="col-md-6">
          <p class="mb-0 font-dark">© {{ date('Y') }}, {{ config('app.name') }}.</p>
        </div>
      </div>
    </div>
  </div>
